...
public:
	...
	Wizard() : Character{}
	{
		...
		get_abilities().emplace_back(std::make_unique<Ability>("Fireball", 2u, 1u, 4u, AbilityTarget::enemy, AbilityScalar::intelligence));
	}
...
private:
	void level_up() override
	{
		...
		{
			get_abilities().emplace_back(std::make_unique<Ability>("Icebolt", 3u, 1u, 6u, AbilityTarget::enemy, AbilityScalar::intelligence));
		}
	}
};