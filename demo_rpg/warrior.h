...
class Warrior : public HitPoint, public Stat, public LevelSystem
{
public:
	static constexpr hit_point_type BASE_HIT_POINT = static_cast<hit_point_type>(18u);
	...
	static constexpr hit_point_type HIT_POINT_GROWTH = static_cast<hit_point_type>(9u);
	...
	Warrior() : HitPoint{ BASE_HIT_POINT, BASE_HIT_POINT }, Stat{ BASE_STRENGTH, BASE_INTELLECT }, LevelSystem{} {};
