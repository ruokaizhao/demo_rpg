...
class Cleric : public HitPoint, public Stat, public LevelSystem
{
public:
	static constexpr hit_point_type BASE_HIT_POINT = static_cast<hit_point_type>(14u);
	...
	static constexpr hit_point_type HIT_POINT_GROWTH = static_cast<hit_point_type>(7u);
	...
	Cleric() : HitPoint{ BASE_HIT_POINT, BASE_HIT_POINT }, Stat{ BASE_STRENGTH, BASE_INTELLECT }, LevelSystem{} {};
